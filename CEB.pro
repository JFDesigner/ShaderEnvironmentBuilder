...
win32:TARGET=CEB.exe
!win32:TARGET=CEB.out
...
##----------------------------------------------------------------------------##
# include Flex libs
!win32:LIBS += $$PWD/lib/libfl.a
win32:LIBS += $$(FLEX)/lib/libfl.a
...
!win32{
    ...
    isEmpty(FLEX_BIN) {
        ...
        flexsource.commands = flex.exe --header-file=include/generated/${QMAKE_FILE_BASE}.h -o src/generated/${QMAKE_FILE_BASE}.cpp -+ ${QMAKE_FILE_IN}
        ...
        # run Flex on .lex file to generate lexer
        message("Found Flex Windows")
        # The following section is from :-
        # hipersayan_x (March 1, 2013)  The Samurai Code: Using Flex and Bison with Qt. [online]
        # [Accessed 18 Feb. 2016] Available at: <http://hipersayanx.blogspot.co.uk/2013/03/using-flex-and-bison-with-qt.html>.
        FLEXSOURCES = $$PWD/src/GlslLexer.lex

        flexsource.input = FLEXSOURCES
        flexsource.output = $$PWD/src/generated/${QMAKE_FILE_BASE}.cpp
        flexsource.commands = "$$(FLEX)/flex.exe" --header-file=$$PWD/include/generated/${QMAKE_FILE_BASE}.h -o $$PWD/src/generated/${QMAKE_FILE_BASE}.cpp -+ ${QMAKE_FILE_IN}
        flexsource.variable_out = SOURCES
        flexsource.clean = $$PWD/src/generated/${QMAKE_FILE_BASE}.cpp
        flexsource.name = Flex Sources ${QMAKE_FILE_IN}
        flexsource.CONFIG += target_predeps
        ...
        flexheader.input = FLEXSOURCES
        flexheader.output = $$PWD/include/generated/${QMAKE_FILE_BASE}.h
        fleakheader.commands = @true
        flexheader.variable_out = HEADERS
        flexheader.clean = $$PWD/include/generated/${QMAKE_FILE_BASE}.h
        flexheader.name = Flex Headers ${QMAKE_FILE_IN}
        flexheader.CONFIG += target_predeps no_link
